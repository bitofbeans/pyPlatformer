...
blob_img = pygame.image.load('img/enemy/blob0.png')
platform_x_img = pygame.image.load('img/tile/platform_x.png')
platform_y_img = pygame.image.load('img/tile/platform_y.png')
lava_img = pygame.image.load('img/tile/lava1.png')
coin_img = pygame.image.load('img/tile/coin1.png')
exit_img = pygame.image.load('img/tile/exit.png')
save_img = pygame.image.load('img/ui/save_button.png')
save_img = pygame.transform.scale(save_img, (40, 40))
load_img = pygame.image.load('img/ui/load_button.png')
